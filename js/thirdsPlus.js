...
let c1 = 0;
function task1() {
	let a1 = randomInt(1, 500);
	let b1 = randomInt(1, 500);
	document.querySelector('.row1 .a1').textContent = a1;
	document.querySelector('.row1 .a3').textContent = b1;
	c1 = a1 + b1;
}
...
function task2() {
	let a1 = randomInt(1, 500);
	let b1 = randomInt(1, 500);
	document.querySelector('.row2 .a1').textContent = a1;
	document.querySelector('.row2 .a3').textContent = b1;
	c2 = a1 + b1;
}
task2();
...
function task3() {
	let a1 = randomInt(1, 500);
	let b1 = randomInt(1, 500);
	document.querySelector('.row3 .a1').textContent = a1;
	document.querySelector('.row3 .a3').textContent = b1;
	c3 = a1 + b1;
}
task3();
...
function task4() {
	let a1 = randomInt(1, 500);
	let b1 = randomInt(1, 500);
	document.querySelector('.row4 .a1').textContent = a1;
	document.querySelector('.row4 .a3').textContent = b1;
	c4 = a1 + b1;
}
task4();
...
function task5() {
	let a1 = randomInt(1, 500);
	let b1 = randomInt(1, 500);
	document.querySelector('.row5 .a1').textContent = a1;
	document.querySelector('.row5 .a3').textContent = b1;
	c5 = a1 + b1;
}
task5();
...
function task6() {
	let a1 = randomInt(1, 500);
	let b1 = randomInt(1, 500);
	document.querySelector('.row6 .a1').textContent = a1;
	document.querySelector('.row6 .a3').textContent = b1;
	c6 = a1 + b1;
}
task6();
...
function task7() {
	let a1 = randomInt(1, 500);
	let b1 = randomInt(1, 500);
	document.querySelector('.row7 .a1').textContent = a1;
	document.querySelector('.row7 .a3').textContent = b1;
	c7 = a1 + b1;
}
task7();
...
function task8() {
	let a1 = randomInt(1, 500);
	let b1 = randomInt(1, 500);
	document.querySelector('.row8 .a1').textContent = a1;
	document.querySelector('.row8 .a3').textContent = b1;
	c8 = a1 + b1;
}
task8();
...
function task9() {
	let a1 = randomInt(1, 500);
	let b1 = randomInt(1, 500);
	document.querySelector('.row9 .a1').textContent = a1;
	document.querySelector('.row9 .a3').textContent = b1;
	c9 = a1 + b1;
}
task9();
...
function task10() {
	let a1 = randomInt(1, 500);
	let b1 = randomInt(1, 500);
	document.querySelector('.row10 .a1').textContent = a1;
	document.querySelector('.row10 .a3').textContent = b1;
	c10 = a1 + b1;
}
task10();
