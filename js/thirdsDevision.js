...
function task1() {
	...
	document.querySelector('.row1 .a1').textContent = a * b;
	document.querySelector('.row1 .a3').textContent = a;
	c1 = (a * b) / a;
}

task1();

document.querySelector('.b-1').addEventListener('click', function (e) {
...
function task2() {
	let a = randomInt(2, 10);
	let b = randomInt(2, 10);
	document.querySelector('.row2 .a1').textContent = a * b;
	document.querySelector('.row2 .a3').textContent = a;
	c2 = (a * b) / a;
}
task2();
...
function task3() {
	let a = randomInt(2, 10);
	let b = randomInt(2, 10);
	document.querySelector('.row3 .a1').textContent = a * b;
	document.querySelector('.row3 .a3').textContent = a;
	c3 = (a * b) / a;
}
task3();
...
function task4() {
	let a = randomInt(2, 10);
	let b = randomInt(2, 10);
	document.querySelector('.row4 .a1').textContent = a * b;
	document.querySelector('.row4 .a3').textContent = a;
	c4 = (a * b) / a;
}
task4();
...
function task5() {
	let a = randomInt(2, 10);
	let b = randomInt(2, 10);
	document.querySelector('.row5 .a1').textContent = a * b;
	document.querySelector('.row5 .a3').textContent = a;
	c5 = (a * b) / a;
}
task5();
...
function task6() {
	let a = randomInt(2, 10);
	let b = randomInt(2, 10);
	document.querySelector('.row6 .a1').textContent = a * b;
	document.querySelector('.row6 .a3').textContent = a;
	c6 = (a * b) / a;
}
task6();
...
function task7() {
	let a = randomInt(2, 10);
	let b = randomInt(2, 10);
	document.querySelector('.row7 .a1').textContent = a * b;
	document.querySelector('.row7 .a3').textContent = a;
	c7 = (a * b) / a;
}
task7();
...
function task8() {
	let a = randomInt(2, 10);
	let b = randomInt(2, 10);
	document.querySelector('.row8 .a1').textContent = a * b;
	document.querySelector('.row8 .a3').textContent = a;
	c8 = (a * b) / a;
}
task8();
...
function task9() {
	let a = randomInt(2, 10);
	let b = randomInt(2, 10);
	document.querySelector('.row9 .a1').textContent = a * b;
	document.querySelector('.row9 .a3').textContent = a;
	c9 = (a * b) / a;
}
task9();
...
function task10() {
	let a = randomInt(2, 10);
	let b = randomInt(2, 10);
	document.querySelector('.row10 .a1').textContent = a * b;
	document.querySelector('.row10 .a3').textContent = a;
	c10 = (a * b) / a;
}
task10();
